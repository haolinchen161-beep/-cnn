...
N_TRAIN = int(os.getenv("N_TRAIN", "1200"))
N_VAL = int(os.getenv("N_VAL", "150"))
N_TEST = int(os.getenv("N_TEST", "150"))
...
OUT_DIR = os.getenv("OUT_DIR", os.path.join(os.path.dirname(__file__), "data_modal_residue_stage1500"))
VIZ_DIR = os.getenv("VIZ_DIR", os.path.join(os.path.dirname(__file__), "mesh_viz_modal_residue_stage1500"))
