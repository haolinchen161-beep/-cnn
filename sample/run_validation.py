"""MeshGraphNet modal-FRF training entrypoint."""
...
class SimpleArgs:
    def __init__(self):
        ...
        self.fp16 = True
        self.dir = os.path.join(os.path.dirname(__file__), "output_meshgraphnet")
        self.debug = False


def main():
    print("=" * 80)
    print("FEM-aware MeshGraphNet Modal-FRF training")
    print("=" * 80)
    args = SimpleArgs()
